defmodule MsElixirLoginBancolombia.Utils.CustomTelemetry do
  ...
  def custom_telemetry_events() do
    ...
    # Events for metrics
    :telemetry.attach(
      "ms_elixir_login_bancolombia-plug-stop",
      [:ms_elixir_login_bancolombia, :plug, :stop],
      &CustomTelemetry.handle_custom_event/4,
      nil
    )

    :telemetry.attach(
      "ms_elixir_login_bancolombia-vm-memory",
      [:vm, :memory],
      &CustomTelemetry.handle_custom_event/4,
      nil
    )
  ...
  def handle_custom_event([:ms_elixir_login_bancolombia, :plug, :stop], measures, metadata, _) do
    :telemetry.execute(
