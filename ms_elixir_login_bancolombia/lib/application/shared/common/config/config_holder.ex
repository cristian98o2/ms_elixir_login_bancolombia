defmodule MsElixirLoginBancolombia.Config.ConfigHolder do
  use GenServer
  alias MsElixirLoginBancolombia.Config.AppConfig
  @table_name :ms_elixir_login_bancolombia_config
  ...
  defp load_additional_properties(%AppConfig{} = config) do
    Application.get_env(:ms_elixir_login_bancolombia, :config_loaders, [])
...
defmodule MsElixirLoginBancolombia.Config.ConfigHolder.PropertiesLoaderBehaviour do
  @moduledoc """
  Behaviour for load additional properties into AppConfig
  """
  alias MsElixirLoginBancolombia.Config.AppConfig
